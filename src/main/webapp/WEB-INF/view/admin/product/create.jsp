              ...
              <div class="col-md-6 col-12 mx-auto">
                <form:form method="post" action="/admin/product/create" modelAttribute="newProduct" class="row" enctype="multipart/form-data">
                  ...
                  <div class="md-3 col-12 col-md-6">
                    ...
                    <form:input type="name" class="form-control ${not empty errorName? 'is-invalid' : ''}" path="name" />
                    ${errorName}
                  </div>
                  <div class="md-3 col-12 col-md-6">
                  ...
                  <div class="md-3 col-12 col-md-6">
                    ...
                    <form:textarea class="form-control ${not empty errorShortDesc? 'is-invalid':''}" path="shortDesc" />
                    ${errorShortDesc}
                  </div>
                  <div class="md-3 col-12 col-md-6">
                  ...
                  <div class="mb-3 ">
                    ...
                    <input type="file" id="productFile" class="form-control" accept=".png, .jpg, .jpeg" name="hoidanitFile" />
                  </div>
