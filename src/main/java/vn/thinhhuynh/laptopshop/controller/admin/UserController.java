...
public class UserController {
    ...
    private final UserService userService; // xu ly logic user (CRUD user , tim user)
    private final UploadService uploadService; // upload file (avatar)
    ...
    public String createUserPage(Model model,
            ...
            @RequestParam("hoidanitFile") MultipartFile file) // lấy một parameter cụ thể từ form hoặc URL.
    {
    ...
    public String postUpdateUser(
        ...
        if (currentUser != null) {
            ...
            currentUser.setRole(
                    this.userService.getRoleByName(hoidanit.getRole().getName()));
    ...
    @PostMapping("/admin/user/delete") // POST
